...
import { createStyles, IconButton, Theme, withStyles, WithStyles, Toolbar, Tooltip, Typography } from '@material-ui/core';
...
const useToolbarStyles = (theme: Theme) => createStyles({
  root: {
    ...
    <Toolbar className={classNames(classes.root, { [classes.highlight]: numSelected > 0 })}>
      <div className={classes.title}>
        {numSelected > 0
          ...
          : (<Typography variant='h6' id='tableTitle'>Nutrition</Typography>)
        }
      </div>
